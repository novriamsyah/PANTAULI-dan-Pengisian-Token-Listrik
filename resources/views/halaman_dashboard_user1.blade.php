...
@if(auth()->user()->role == 'admin' || auth()->user()->role == 'user1')
<style type="text/css">
...
<div class="container-fluid mt-3">        
    ...
    <div class="row">
        <div class="col-lg-3 col-sm-6">
            <div class="card gradient-5">
                <div class="card-body">
                    <h3 class="card-title text-white">Watt-hour Sisa</h3>
                    <div class="d-inline-block">
                        <h2 class="text-white" id="sisaPulsa">0</h2>
                        <p class="text-white mb-0">Sisa Wh</p>
                    </div>
                    <span class="float-right display-5 opacity-5"><i class="fa fa-history"></i></span>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-sm-6">
            <div class="card gradient-2">
                <div class="card-body">
                    ...
                    <div class="d-inline-block">
                        <h2 class="text-white" id="tegangan">{{ $tampung->tegangan }} Volt</h2>
                ...
                <div class="row">
                    <div class="col-md-12 d-flex justify-content-between">
                        ...
                        <div class="semua-btn">
                            ...
                            <button class="btn btn-sm font-weight-bold text-dark">Semua <i class="fa fa-long-arrow-right" aria-hidden="true"></i></button></a>
                        </div>
                    </div><br><br>
                    <div class="col-md-12 mt-4">
                        <canvas id="myChartdy" style="width: 100%;"></canvas>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-lg-4">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title"> 8 data Daya Aktif Terakhir</h4>
                <hr>
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-12 d-flex justify-content-between">
                            <div class="judul" style="width: 100%">
                              {{-- <img src="{{ asset('gif/livv.gif') }}" width="65" alt=""> --}}
                                <h4 style="text-align: center"> Monitor Daya Realtime</h4>
...
<script>
    ...
    channel.bind('my-event', function(data) {
      ...
      sPulsa.innerHTML = data.sisa_pulsa + " Wh";
