...
<div class="row page-titles mx-0">
    <div class="col p-md-0">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="{{ url('/laporan_pf') }}">Laporan PF</a></li>
        </ol>
    </div>
</div>
        ...
        <div class="col-md-12">
        	<div class="card">
                <div class="card-body">
                    <div class="row">
                    	<div class="col-md-12">
                    		<h4 class="card-title">Daftar Laporan PF</h4>
                    	</div>
                    </div>
                    <div class="row mt-3">
                    	<div class="col-md-12">
                    		<form class="filter_form" target="_blank" action="{{ url('/pdf_laporan_pf') }}" method="POST">
                    			@csrf
		                        ...
		                        <table class="table table-striped table-bordered zero-configuration">
		                            ...
		                            <tbody class="isi_tabel">
		                            	...
		                            	<tr>
		                            		...
		                            		<th class="align-middle text-center">{{ $transaksi->pf }}</th>
		                            		<td class="align-middle text-center">{{ $transaksi->pf_sudah }}</td>
