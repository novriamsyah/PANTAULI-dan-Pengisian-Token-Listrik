...
<div class="row page-titles mx-0">
    <div class="col p-md-0">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="{{ url('/laporan_daya') }}">Laporan Daya</a></li>
        </ol>
    </div>
</div>
        ...
        <div class="col-md-12">
        	<div class="card">
                <div class="card-body">
                    ...
                    <div class="row mt-3">
                    	<div class="col-md-12">
                    		<form class="filter_form" target="_blank" action="{{ url('/pdf_laporan_daya') }}" method="POST">
                    			@csrf
                    		...
                    		<div class="table-responsive">
		                        <table class="table table-striped table-bordered zero-configuration">
		                            ...
		                            <tbody class="isi_tabel">
		                            	<?php $number = 1; ?>
		                            	@foreach($pf_hasil as $transaksi)
		                            	<tr>
		                            		<th class="align-middle text-center">{{ $number }}</th>
		                            		<th class="align-middle text-center">{{ $transaksi->dy_aktif }}</th>
		                            		<td class="align-middle text-center">{{ $transaksi->dy_reaktif }}</td>
											<td class="align-middle text-center">{{ $transaksi->dy_semu }}</td>
