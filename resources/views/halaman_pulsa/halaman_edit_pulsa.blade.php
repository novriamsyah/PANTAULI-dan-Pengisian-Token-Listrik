...
<div class="row page-titles mx-0">
    <div class="col p-md-0">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="{{ url('/edit_pulsa') }}">Edit Pulsa</a></li>
        </ol>
    </div>
</div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-validation">
                        <form class="form-valide" action="{{  url('/update_pulsa/' . $id) }}" method="post" name="outlet_baru_form">
                            @csrf
                            <div class="form-group row">
                                <label class="col-lg-4 col-form-label" for="val-nama">Nama<span class="text-danger">*</span>
                                </label>
                                <div class="col-lg-6">
                                    <input type="text" class="form-control" id="val-nama" name="nama" placeholder="Masukkan nama" value="{{ $outlets->nama_langgan }}">
                                </div>
                            </div>
                            {{-- <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" class="form-control" id="val-hotline" name="noHp" placeholder="Masukkan Nomor HP" value="{{ $outlets->no_hp_langgan }}">
                                </div>
                            </div> --}}
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="number" class="form-control" id="val-pulsa" name="pulsa" placeholder="Masukkan Jumlah kWh" value="{{ $outlets->jml_pulsa }}">
                                </div>
                            </div>
                            {{-- <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="number" class="form-control" id="val-harga" name="harga" placeholder="Masukkan Harga Pulsa" value="{{ $outlets->harga_paket }}">
                                </div>
                            </div> --}}
                            <div class="form-group row">
